...
# SSH keys already deployed via cloud-init, just ensure correct permissions
# cp /home/$user/{$certName,$certName.pub} /home/$user/.ssh  # Not needed - keys deployed via cloud-init
